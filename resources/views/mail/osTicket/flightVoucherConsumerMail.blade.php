...
<div class="container">
                    ...
                    if($val['ffp_number'] != '' && $val['ffp_number'] != '[]'){
                        ...
                        foreach($ffpAry as  $ffpKey => $ffpVal){
                            if($ffpVal != '' && $ffpNumAry[$ffpKey] != ''){
                                $ffpDispDiv .= $ffpKey.' - '.$ffpNumAry[$ffpKey].', ';
                            }
                        }   
                    }
                    if($val['seats'] != ''){
                ...
                @foreach($flight_passenger as $paxKey => $paxVal)
                    @php
                        ...
                        if($paxVal['ffp_number'] != '' && $paxVal['ffp_number'] != '[]'){
                            ...
                            foreach($ffpAry as  $ffpKey => $ffpVal){
                                if($ffpVal != '' && $ffpNumAry[$ffpKey] != ''){
                                    $ffpDisp .= $ffpKey.' - '.$ffpNumAry[$ffpKey].', ';
                                }
                            }  
                        }
    ...
    <h4 style="color: #00bcd4">Supplier Details </h4>
    @include('mail.flights.flightVoucherSupplierMail', ['data' => $allData, 'headingFlag' => '1'])
