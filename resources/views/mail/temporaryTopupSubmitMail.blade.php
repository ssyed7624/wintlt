...
<body>
	...
	@if($actionFlag == 'create')
		<tr>
			@lang('mail.temporary_topup_mail_content')
			<pre></pre>
		</tr>
		<tr>
	...
	@elseif($actionFlag == 'approved')
		<tr>
			@lang('mail.temporary_topup_approve_mail_content',['currency'=>$currency, 'amount'=>$amount])
			<pre></pre>
		</tr>
		<tr>
	...
	@elseif($actionFlag == 'rejected')
		<tr>
			@lang('mail.temporary_topup_reject_mail_content1',['currency'=>$currency, 'amount'=>$amount])
			<pre></pre>
		</tr>
		<tr>
