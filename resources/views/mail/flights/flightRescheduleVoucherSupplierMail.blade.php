...
$aPcc = array_column($flight_itinerary, 'pcc');
$aGds = array_column($flight_itinerary, 'gds');
$pccList = '';
if(isset($aPcc) and !empty($aPcc)){
    $pccList = implode(",",$aPcc);
}
...
{
    $paymentAllDetails = json_decode($payment_details,true);
}
        ...
        <div class="position-ref">
            <div class="content">
                ...
                <table class="table mail-table bookingConformation" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="bookingConformationTh">PCC</td>
                        <td>{{$pccList}}</td>
                    </tr>
                    @if($headingFlag == 0)
                        <tr>
