...
<html>
	<head>
		<title>Flight Refund</title>
	</head>
	<body>
		<table>
			<tr><td>Hi {{$account_name}},</td></tr>
			<tr><td>Your flight booking failed. Your refunded amount is {{$refundCurrency}} {{$refundAmount}}</td></tr>
		</table>
		<div class="mb-2">
        ...
        @if(isset($booking_contact) && !empty($booking_contact))
            ...
            <p>
                ...
                {{$stateList[$booking_contact['state']]['name']}}, 
                <br>
                {{$countryList[$booking_contact['country']]['country_name']}}, 
                <br>
		...
		@if(!isset($regardsAgencyPhoneNo))
	        @php $regardsAgencyPhoneNo = ''; @endphp
	    @endif
		@include('mail.regards', ['acName' => $loginAcName,'parent_account_phone_no'=>$regardsAgencyPhoneNo, 'miniLogo' => $miniLogo])
	</body>
</html>
