@php
    ...
    $titleInfo = Common::getAgencyTitle(isset($parent_account_id) ? $parent_account_id : $account_id);
...
<div class="container">
    ...
    @endif
    @include('mail.regards', ['acName' => $parent_account_name,'parent_account_phone_no'=>$parent_account_phone_no, 'miniLogo' => $miniLogo])
@endsection