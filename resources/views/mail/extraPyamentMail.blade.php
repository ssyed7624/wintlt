...
<body>
	<section class="section-wrapper">
		...
		<div class="container">
		 	...
		 	@if(!isset($inputData['extra_payment_status_mail']))
				Your booking amount has been changed.<br>
			@else
				Thank you for making the requested payment of <b>{{$inputData['payment_currency']}}  {{Common::getRoundedFare($inputData['payment_amount'])}}</b>  towards your booking with us.<br>
			@endif
			...
			<br>
			@if(!isset($inputData['extra_payment_status_mail']))
				*Note : {{__('booking.user_making_payment')}}
            @else
                If you further have any concern or request, feel free to reach out our customer care.
			@endif
		</div>
    </section>
