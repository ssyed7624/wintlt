...
namespace App\Models\LookToBookRatio;
...
class LookToBookRatio extends Model
{
    ...
    public static function getLookToBookSearchCount($consumerId)
    {
        ...
        if(!empty($getLookBookRatio)){            
            ...
            foreach($getLookBookRatio as $bookingRatio){                
                $supplierBookingRatio[$bookingRatio['supplier_id']] = [
