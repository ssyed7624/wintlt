...
class AgencySettings extends Model
{
    ...
    protected $fillable = [
        ...
        'domain_settings',
        'unique_url',
        'unique_url_enable_prefix',
        'custom_domain',
        'custom_domain_enable_prefix',
        'same_as_agency_address',
        'billing_address',
        'billing_country',
        'billing_state',
        'billing_city', 
        'billing_alternate_phone_code',
        'billing_alternate_phone',
        'billing_alternate_email',
        'created_at','updated_at',
        'created_by','updated_by',
        'billing_alternate_phone_code_country',
    ...
    public function agencyUser(){
        return $this->belongsTo(AccountDetails::class,'agency_id');
    }
}
