...
namespace App\Libraries\ERunActions;
use App\Libraries\ERunActions\ERunActionsHttpClient;
...
class ERunActions
{
	 ...
	 */
	public static function touchUrl($url,$postData=null,$contentType=null,$urlParams=array(), $customHeaders=array())
	{
		...
		$client->request($host,$port,$uri,$verb,$urlParams,$postData,$contentType, [], $customHeaders);
	}
	...
	public static function logMessage($message,$level='info',$controllerId='',$actionId='')
	{
		...
		logWrite('erunLog', 'erunLog', $message.$category);
