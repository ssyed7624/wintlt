...
namespace App\Libraries\CMSPaymentGateway\Atom;

class TransactionRequest
{
	public  $liveUrl = 'https://payment.atomtech.in/paynetz/epi/fts';
	public  $testUrl = 'https://paynetzuat.atomtech.in/paynetz/epi/fts';
